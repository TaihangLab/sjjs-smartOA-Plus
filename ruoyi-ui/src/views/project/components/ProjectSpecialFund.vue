...
<!--                    </el-select>-->
<!--                    <el-input class="custom-input" type="number" size="medium"></el-input>-->
...
<!--                            </el-select>-->
<!--                            <el-input class="custom-input" type="number" size="small"></el-input>-->
<!--                            <el-button icon="el-icon-circle-plus" circle type="success" plain @click="addRow" ></el-button>-->
<!--                        </div>-->
<!--                    </template>-->
<!--                    <el-table v-if="isTableVisible" :data="tableData" style="width: 100%" :width="130">-->
...
<!--                                <el-button type="danger" icon="el-icon-remove" circle plain @click="removeRow(scope.$index)"></el-button>-->
<!--                            </template>-->
<!--                        </el-table-column>-->
...
<!--            this.tableData.push({ name: `Item ${this.tableData.length + 1}`, category: '' });-->
<!--        },-->
<!--        removeRow(index) {-->
        ...
        <el-card v-for="(card1, index1) in cards1" :key="index1" shadow="hover">
            ...
            <div class="card-container">
                <el-card v-for="(card2, index2) in cards2[index1]" :key="index2" shadow="hover" style="width: 25%;">
                    ...
                    <el-table :data="tableData[index1][index2]" v-if="isTableVisible[index1][index2]"  style="width: 100%" :width="130">
                        <el-table-column label="三级标签" align="center">
                            <template slot-scope="scope">
                                <el-select v-model="scope.row.category" placeholder="Select category" size="mini">
